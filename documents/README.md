...
| `HANDOVERS/handover_sessions_k_p_walkable_ship.md` | **CURRENT** | **The live handover.** Sessions K–P: the walkable-ship program — glass, double-sided, ambient scale, specular IBL + real BRDF LUT, collision design + field triage, local + authored lights, expanded-map haze root-cause. Priority queue: field follow-ups, GGX prefilter tool, sh_from_cubemap file orientation, R5 spaceflight remainder. |
