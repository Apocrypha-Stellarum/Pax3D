...
| `ENGINE_SURGERY_PLAN.md` | **CURRENT** | The deletion program. **Windows 2+3+4 executed** (DX9 + dead backends + mobile machinery gone, −43k lines; Window 4 `baf541388a`, 2026-07-19); remaining R6 = Vulkan watch only. |
| `GITHUB_PRESENCE.md` | **CURRENT** | The public-repo program (standalone repo since 2026-07-28, fork archived): what was done (rebrand, gallery, release v2026.07, roadmap), screenshot/release recipes, author-identity policy, the future-session queue, outstanding manual steps. |
...
| `OPENWORLD_FEEDBACK_RESPONSE_5.md` | **CURRENT** | Round 4 addenda (Session Q): P2 core-profile combine drop diagnosed (expected upstream default-shader behavior; probe_texturestage; the requested warning LANDED in Session R, `e21bfc6ea7`); sh_from_cubemap face table pinned end-to-end; Mars adoption lessons folded into the look guide; west-sun P0 fix re-pointed at the planetside team; GGX prefilter tool announced. |
